...
const About = () => {
  ...
  return (
    <div id="About" className="bg-purple-300">
      <div className="lg:px-56 px-10  lg:py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center">
        ...
        <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
          ...
          <p data-aos="fade-left" className="cursor-pointer select-none">
            Hi, I'm John Ezekiel, a 15-year-old passionate front-end developer.
            I enjoy creating visually appealing and user-friendly interfaces
            using the latest technologies in web development. My journey in
            coding started with curiosity and has grown into a deep interest in
            crafting responsive and dynamic websites. With a focus on clean
            design and performance, I continuously strive to improve my skills
            and bring ideas to life on the web. Check my resume below.
          </p>
